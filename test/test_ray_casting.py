...
from topoutils import ray_casting
...
class TestRayCasting(TestCase):
    ...
    def test_vector_plane_intersection__when_ray_does_not_intersect_plane(self):
        ...
        self.assertIsNone(ray_casting.vector_plane_intersection(self.X, normal, p0, direction_vector))
    ...
    def test_vector_plane_intersection(self):
        ...
        intersection_point = ray_casting.vector_plane_intersection(self.X, normal, p0, direction_vector)
